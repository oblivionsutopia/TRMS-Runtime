...
CREATE TABLE USERS(
EMPLOYEE_ID NUMBER UNIQUE NOT NULL PRIMARY KEY,
...
INSERT INTO REIMBURSEMENTS (EMPLOYEE_ID, JOBTYPE,REASON,DATE_COMP,START_TIME, END_TIME, STATUS,STATUS_TIME,AVAIL_AMT,PEND_AMT,REIMB_AMT,REIMB_RESET) VALUES (07253005,1,'great', CURRENT_TIMESTAMP,'01-APR-2001','01-MAY-2001',2,CURRENT_TIMESTAMP,1000.00,333.00,0.00,365);
INSERT INTO REIMBURSEMENTS (EMPLOYEE_ID, JOBTYPE,REASON,DATE_COMP,START_TIME, END_TIME, STATUS,STATUS_TIME,AVAIL_AMT,PEND_AMT,REIMB_AMT,REIMB_RESET) VALUES (07253006,1,'summon', CURRENT_TIMESTAMP,'01-DEC-2001','01-JUN-2001',2,CURRENT_TIMESTAMP,1000.00,452.00,0.00,365);
